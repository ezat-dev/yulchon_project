...
dataTable = new Tabulator('#dataTable', {
  ...
  columns: [
	    ...
	    { title: "고객사 부여 품번", field: "customer_product_code_number", width: 170, hozAlign: "center", headerFilter: "input"},
	    { title: "출력용 인보이스", field: "extra_invoice_no", width: 170, hozAlign: "center", headerFilter: "input"},
	    ...
	    { title: "출력용 규격", field: "extra_spec", width: 170, hozAlign: "center", headerFilter: "input"},
